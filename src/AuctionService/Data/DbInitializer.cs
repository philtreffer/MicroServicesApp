...
{
    //The static keyword allows us to use this method inside another class without initializing a class of DbInitializer
public static void InitDb(WebApplication app)
{
        // Step 1: we need to create a scope to inject the dbCOntext Service into a class
    ...
    {   // Apply Migrations or creates database, if it does not exist
